...
<body id="page-top">
  ...
  <header class="bg-primary text-white">
    <div class="container text-center">
      <h1><b style="color:red; font-size:60px">COVID19-TMS</b></h1>
      <p class="lead">COVID19 - Testing Management System</p>
      <marquee style="color:red; font-size:50px;">!!!!!!!Please Stay home and stay safe!!!!!!!</marquee>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <h2 style="background-color:red;">About Coronovirus</h2>
          ...
          <h2 style="background-color:red;">About Testing Management system</h2>
          <p class="lead">What is the coronovirus test management system ?</p>
          <video width="800" height="500" controls>
            <source src="https://www.youtube.com/watch?v=akiXEfWW-V0" type="video/mp4">
 ...
 <section id="services" class="bg-light">
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <h2 style="background-color:red;">Covid-19 Symptoms</h2>
          <hr />
...
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
<hr />
<p><strong>Shortness of Oxygen!</strong><br />
  Reported illnesses have ranged from mild symptoms to severe illness and death</p>
  <hr />
  <h2 style="background-color:red;"><strong>Less common Symptoms</strong></h2>
  <ol>
<li>Sore throat</li>
<li>Headache</li>
...
red or irritated eyes</li>
  ...
  <section id="contact">
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <h2 style="background-color:red;">Prevention</h2>
  <ul>
            <li>Wash your Hands often</li>
            <li>Wear A Face mask</li>
            <li>Avoid contact with sick people</li>
            <li>Always cover your cough or sneeze</li>
            <LI>DO not get closure with any people</LI>
            <li>STAY HOME AND STAY SAFE</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; MUZEEBURRAHAMAN Website 2020</p>
    </div>
    <!-- /.container -->
  </footer>
